...
public partial class Result : TBase
{
  ...
  public Result DeepCopy()
  {
    ...
    {
      tmp48.Response = (Response)this.Response.DeepCopy();
    }
            ...
            {
              {
                ...
                Events = new List<@Event>(_list49.Count);
            ...
            {
              {
                ...
                Logs = new List<Log>(_list52.Count);
    ...
    try
    {
      ...
      if((Events != null) && __isset.events)
      {
        ...
        await oprot.WriteFieldBeginAsync(field, cancellationToken);
        {
          ...
          foreach (@Event _iter55 in Events)
          {
